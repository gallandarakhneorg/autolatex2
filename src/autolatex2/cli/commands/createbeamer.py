...
class MakerAction(AbstractMakerAction):
	...
	help : str = _T('Create LaTeX style file into the document directory that provides the standard AutoLaTeX control sequences for the LaTeX Beamer library. The created file will be named \'autolatex-beamer.sty\'. If a file with this name already exists, it may be overwritten')
