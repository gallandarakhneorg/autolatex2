...
class TestCreateStyAction(AbstractCommandTest):

	def __init__(self, x):
		super().__init__(x, 'createsty')
	...
	def _initialize_test_folder(self):
		...
		self._sty_file = os.path.normpath(os.path.join(self._tmp_folder_name, 'autolatex.sty'))
