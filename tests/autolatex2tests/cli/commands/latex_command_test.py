...
class TestLatexAction(AbstractCommandTest):

	def __init__(self, x):
		super().__init__(x, 'latex')
	...
	def _initialize_test_folder(self):
		...
		self._out_file = os.path.normpath(os.path.join(self._tmp_folder_name, 'rootfile.pdf'))
	...
	def test_document(self):
		self.assertFalse(os.path.isfile(self._out_file))
