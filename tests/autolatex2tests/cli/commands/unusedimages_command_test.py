...
class TestUnusedImagesAction(AbstractCommandTest):

	def __init__(self, x):
		super().__init__(x, 'unusedimages')
	...
	def _initialize_image_folder(self):
		...
		shutil.copyfile(os.path.normpath(os.path.join(self._resource_directory2, 'test12img.pdf')),
						os.path.normpath(os.path.join(self._img_folder, 'img1.pdf')))

		shutil.copyfile(os.path.normpath(os.path.join(self._resource_directory, 'testimg.svg')),
						os.path.normpath(os.path.join(self._img_folder, 'img2.svg')))
		shutil.copyfile(os.path.normpath(os.path.join(self._resource_directory2, 'test12img.pdf')),
						os.path.normpath(os.path.join(self._img_folder, 'img2.pdf')))
		...
		shutil.copyfile(os.path.normpath(os.path.join(self._resource_directory2, 'test12img.pdf')),
						os.path.normpath(os.path.join(self._img_folder, 'img3.jpg')))

		shutil.copyfile(os.path.normpath(os.path.join(self._resource_directory2, 'test12img.pdf')),
						os.path.normpath(os.path.join(self._img_base_folder, 'img4.pdf')))
