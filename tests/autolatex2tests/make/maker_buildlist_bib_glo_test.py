...
class TestBuildListBibliographyGlossaryMaker(AbstractBaseTest):
	"""
	Create a build list from a project with bibliography, and glossary.
	"""
	...
	def __install_test_environment(self):
		...
		shutil.copyfile(os.path.normpath(os.path.join(self.__resource_directory, 'test30.tex')), self.__root_file)
