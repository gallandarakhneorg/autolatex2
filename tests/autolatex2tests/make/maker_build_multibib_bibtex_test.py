...
class TestBuildWithMultibibBibtexMaker(AbstractBaseTest):
	"""
	Document using Multibib databases and BibTeX tool.
	"""
	...
	def __install_test_environment(self):
		...
		self.__bib_a_file = os.path.normpath(os.path.join(self.__tmp_folder_name, 'mybiblio.bib'))
		...
		shutil.copyfile(os.path.normpath(os.path.join(self.__resource_directory, 'test28.tex')), self.__root_file)
		shutil.copyfile(os.path.normpath(os.path.join(self.__resource_directory, 'test28.bib')), self.__bib_a_file)
		shutil.copyfile(os.path.normpath(os.path.join(self.__resource_directory, 'test28.bib')), self.__bib_b_file)
