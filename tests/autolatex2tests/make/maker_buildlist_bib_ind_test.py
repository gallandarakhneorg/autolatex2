...
class TestBuildListBibliographyIndexMaker(AbstractBaseTest):
	"""
	Create a build list from a project with bibliography, ad index.
	"""
	...
	def __install_test_environment(self):
		...
		shutil.copyfile(os.path.normpath(os.path.join(self.__resource_directory, 'test29.tex')), self.__root_file)
