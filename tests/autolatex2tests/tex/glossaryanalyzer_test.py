...
class TestGlossaryAnalyzer(AbstractBaseTest):
	...
	def test_glossaryEntries(self):
		self.assertEqual(SortedSet([
				...
				r'12|Non-uniform random variate generation!Breit-Wigner distribution|hyperindexformat{\see{Cauchy-Lorentz distribution}}',
				...
				r'12|Non-uniform random variate generation!Cauchy-Lorentz distribution!Probability distribution \ensuremath  {f(x)}|hyperpage',
				...
				r'14|Non-uniform random variate generation!Logistic distribution!Probability distribution \ensuremath  {f(x)}|hyperpage',
				...
				r'8|Non-uniform random variate generation!Gauss distribution|hyperindexformat{\see{Normal distribution}}',
