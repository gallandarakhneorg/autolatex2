...
class TestDot2pdfTranslator(AbstractTranslatorTest):

	def __init__(self, *args, **kwargs):
		super().__init__('dot', 'pdf', 'dot2pdf',
						 ['dot2png', 'dot2tex', 'svg2pdf+layers_inkscape',
						  'svg2pdf+layers+tex_inkscape', 'svg2pdf+tex_inkscape', 'svg2png_inkscape'],
						 *args, **kwargs)
