...
class TestSvg2pdflayerstexTranslator(AbstractTranslatorTest):

	def __init__(self, *args, **kwargs):
		super().__init__('+layers+tex.svg', 'pdftex_t', 'svg2pdf+layers+tex_inkscape',
						 ['svg2pdf_inkscape', 'svg2pdf+layers_inkscape', 'svg2pdf+tex_inkscape',
						  'svg2png_inkscape'],
						 *args, **kwargs)
